...
import {TreeStateDirective} from './exercise6/tree-state.directive';
...
@NgModule({
  declarations: [
    ...
    Solution6Component, StateButtonDirective, Exercise6Component, Solution7Component, StateButtonComponent, Exercise7Component, CountryDescriptionPipe, CountryStateComponent, TreeStateDirective,TransclusionComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
