...
@NgModule({
  declarations: [
    ...
    Solution6Component, StateButtonDirective, Exercise6Component, Solution7Component, StateButtonComponent, Exercise7Component, CountryDescriptionPipe, CountryStateComponent, TreeStateDirective
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
